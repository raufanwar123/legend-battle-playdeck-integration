...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsEditor : Editor 
    {
        ...
        public override void OnInspectorGUI()
        {
           ...
           // SerializedProperty FarooqDailyRewards = serializedObject.FindProperty("NewRewards");
           ...
           // EditorGUILayout.PropertyField(FarooqDailyRewards, new GUIContent("Enter Daily Rewards For Game"));
